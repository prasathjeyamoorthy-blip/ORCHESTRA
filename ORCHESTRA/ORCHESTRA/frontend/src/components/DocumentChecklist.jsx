        ...
        {p && (
          <>
            ...
            <div style={sectionStyle}>
              ...
              <Row label="Aadhaar"         value={p.documents?.aadhaar_path?.split(/[\\/]/).pop()}       src="extracted" />
