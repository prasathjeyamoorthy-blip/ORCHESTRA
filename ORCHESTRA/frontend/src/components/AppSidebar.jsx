    ...
    <>
      ...
      <div style={{ padding: "0.5rem 0.375rem", display: "flex", flexDirection: "column", gap: "0.125rem" }}>
        ...
        <div ref={userMenuRef} style={{ position: "relative" }}>
          ...
          {userMenu && (
            <div style={{ position: "absolute", bottom: "calc(100% + 4px)", left: 0, width: open ? "100%" : "9rem", background: "rgba(10,10,10,0.95)", backdropFilter: "blur(16px)", WebkitBackdropFilter: "blur(16px)", border: `1px solid ${border}`, borderRadius: "0.5rem", boxShadow: "0 4px 20px rgba(0,0,0,0.6)", overflow: "hidden", zIndex: 9999 }}>
