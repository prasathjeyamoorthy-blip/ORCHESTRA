...
url = os.getenv("SUPABASE_URL", "https://vnaeznlgijnarwqrwdtz.supabase.co")
# Fallback to key in case service key is not configured
key = os.getenv("SUPABASE_SERVICE_KEY") or os.getenv("SUPABASE_KEY") or "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZuYWV6bmxnaWpuYXJ3cXJ3ZHR6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzY1Mjk4OTQsImV4cCI6MjA5MjEwNTg5NH0.kw8jhS-YErCJgDVkSDj6zBrJK3ytLnFS-2f0YR9D6hw"
...
def save_document(doc_type: str, extracted_data: dict, auth_id: str, person_id: str) -> str:
    from agent.crypto_utils import encrypt_json
...
def get_documents_by_auth(auth_id: str):
    ...
    from agent.crypto_utils import decrypt_json
