  ...
  return (
    <>
      ...
      <div
        ref={cardRef}
        data-glow
        className={`relative rounded-2xl p-0 ${className}`}
        style={{
          '--base': base,
          '--spread': spread,
          '--radius': '16',
          ...
          backgroundImage: `radial-gradient(var(--spotlight-size) var(--spotlight-size) at calc(var(--x, 0) * 1px) calc(var(--y, 0) * 1px), hsl(var(--hue, 210) calc(var(--saturation, 100) * 1%) calc(var(--lightness, 70) * 1%) / 0.08), transparent)`,
