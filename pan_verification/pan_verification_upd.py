...
class AadhaarData(BaseModel):
    ...
    flat_room_door: Optional[str] = None
    building_village: Optional[str] = None
    road_street_post: Optional[str] = None
...
async def run_pan_verification(aadhaar_path: str, photo_path: str, signature_path: str):
    ...
    print()
    print("  ── Mother / Guardian ──")
    print(f"  Mother Name    : {aadhaar_data.mother_name or 'N/A'}")
    print(f"  Mother First   : {aadhaar_data.mother_first_name or 'N/A'}")
    print(f"  Mother Middle  : {aadhaar_data.mother_middle_name or 'N/A'}")
    print(f"  Mother Last    : {aadhaar_data.mother_last_name or 'N/A'}")
    print()
    print("  ── Personal ──")
    print(f"  Date of Birth  : {aadhaar_data.dob or 'N/A'}")
    print(f"  Gender         : {aadhaar_data.gender or 'N/A'}")
    print(f"  Phone No.      : {aadhaar_data.phone or 'N/A'}")
    print(f"  Mobile No.     : {aadhaar_data.mobile_number or 'N/A'}")
    print(f"  Email Id       : {aadhaar_data.email_id or 'N/A'}")
    print(f"  Residential    : {aadhaar_data.residential_status or 'N/A'}")
    print()
    print("  ── Address ──")
    print(f"  Flat/Room/Door : {aadhaar_data.flat_room_door or 'N/A'}")
    print(f"  Building/Village : {aadhaar_data.building_village or 'N/A'}")
    print(f"  Road/Street    : {aadhaar_data.road_street_post or 'N/A'}")
    print(f"  Area/Locality  : {aadhaar_data.area_locality or 'N/A'}")
    ...
    aadhaar_json = {
        ...
        "mother_name": aadhaar_data.mother_name,
        "mother_first_name": aadhaar_data.mother_first_name,
        "mother_middle_name": aadhaar_data.mother_middle_name,
        "mother_last_name": aadhaar_data.mother_last_name,
        "dob": aadhaar_data.dob,
        "gender": aadhaar_data.gender,
        "mobile_number": aadhaar_data.mobile_number,
        "email_id": aadhaar_data.email_id,
        "residential_status": aadhaar_data.residential_status,
        "flat_room_door": aadhaar_data.flat_room_door,
        "building_village": aadhaar_data.building_village,
        "road_street_post": aadhaar_data.road_street_post,
        "area_locality": aadhaar_data.area_locality,
