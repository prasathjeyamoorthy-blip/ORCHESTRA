...
_EXACT_SUBS = [
    ...
    (r'\blac\b',            'lakh'),
    (r'\blacs\b',           'lakh'),
    (r'\blkahs\b',          'lakh'),  # Common typo: lkahs
    (r'\blkah\b',           'lakh'),  # Common typo: lkah
    (r'\blkhs\b',           'lakh'),  # Common typo: lkhs
    (r'\blahks\b',          'lakh'),  # Common typo: lahks
    (r'\blahk\b',           'lakh'),  # Common typo: lahk,
